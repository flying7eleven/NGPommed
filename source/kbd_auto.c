...
/* Automatic backlight */
void kbd_backlight_inhibit_set( int mask ) {
	int lvl;
...
void kbd_backlight_inhibit_clear( int mask ) {
	int flag;
...
void kbd_backlight_inhibit_toggle( int mask ) {
...
static void kbd_auto_process( int id, uint64_t ticks ) {
