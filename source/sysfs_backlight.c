...
static int sysfs_backlight_get( void ) {
	int fd;
	int n;
	char buffer[ 8 ];
...
static int sysfs_backlight_get_max( void ) {
	int fd;
	int n;
	char buffer[ 8 ];
...
static void sysfs_backlight_set( int value ) {
	FILE *fp;
...
static int sysfs_backlight_probe( int driver ) {
