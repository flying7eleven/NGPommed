...
static int evdev_try_add( int fd );
...
static int evdev_is_adb( unsigned short *id ) {
...
/* PowerBook G4 */
static int evdev_is_fountain( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_geyser( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_internal( unsigned short *id ) {
...
/* PMU Lid switch */
static int evdev_is_lidswitch( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_geyser3( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_geyser4( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_geyser4hf( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_wellspring( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_wellspring2( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_wellspring3( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_wellspring4( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_wellspring4a( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_2011mba( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_2012mba( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_2014mba( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_wellspring5( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_apple_internal_keyboard( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
 ...
 */
static int evdev_is_wellspring6( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_appleir( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd_white( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd_mini_alu( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd_alu( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
/* Apple external USB keyboard, aluminium */
static int evdev_is_extkbd_alu_rev_b( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd_alu_wl( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd_alu_wl_2( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_is_extkbd( unsigned short *id ) {
...
static int evdev_is_mouseemu( unsigned short *id ) {
	unsigned short product = id[ ID_PRODUCT ];
...
static int evdev_inotify_init( void ) {
	int ret;
	int fd;
